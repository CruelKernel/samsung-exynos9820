...
#define FIPS_MAX_LEN_IV		48 
#define FIPS_MAX_LEN_KEY	132
#define FIPS_MAX_LEN_DIGEST	64
#define FIPS_MAX_LEN_PCTEXT	512
#define FIPS_MAX_LEN_ENTROPY	48
#define FIPS_MAX_LEN_STR	128
...
struct cipher_testvec {
	...
	const char iv_out[FIPS_MAX_LEN_IV];
...
struct aead_testvec {
	...
	const char iv[FIPS_MAX_LEN_IV];
	const char input[FIPS_MAX_LEN_PCTEXT];
	const char assoc[FIPS_MAX_LEN_DIGEST];
	const char result[FIPS_MAX_LEN_PCTEXT];
	unsigned char tap[MAX_TAP];
...
struct drbg_testvec {
	const unsigned char entropy[FIPS_MAX_LEN_ENTROPY];
	size_t entropylen;
	const unsigned char entpra[FIPS_MAX_LEN_ENTROPY];
	const unsigned char entprb[FIPS_MAX_LEN_ENTROPY];
	size_t entprlen;
	const unsigned char addtla[FIPS_MAX_LEN_IV];
	const unsigned char addtlb[FIPS_MAX_LEN_IV];
	size_t addtllen;
	const unsigned char pers[FIPS_MAX_LEN_STR];
	size_t perslen;
	const unsigned char expected[FIPS_MAX_LEN_STR];
	size_t expectedlen;
};
...
struct kbkdf_testvec {
	...
	uint32_t L;
	const uint8_t Ki[FIPS_MAX_LEN_KEY];
	const uint8_t Ko[FIPS_MAX_LEN_KEY];
	const uint8_t Label[FIPS_MAX_LEN_STR];
	const uint8_t Context[FIPS_MAX_LEN_STR];
};
...
#define vmac_string1	"\x01\x01\x01\x01\x02\x03\x02\x02"	\
...
#define vmac_string2	"\x61\x62\x63\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
...
#define vmac_string3	"\x61\x62\x63\x61\x62\x63\x61\x62"	\
						"\x63\x61\x62\x63\x61\x62\x63\x61"	\
						"\x62\x63\x61\x62\x63\x61\x62\x63"	\
						"\x61\x62\x63\x61\x62\x63\x61\x62"	\
						"\x63\x61\x62\x63\x61\x62\x63\x61"	\
						"\x62\x63\x61\x62\x63\x61\x62\x63"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
...
#define vmac_string4	"\x62\x63\x65\x66\x69\x6a\x6c\x6d"	\
						"\x6f\x70\x72\x73\x74\x75\x77\x78"	\
						"\x7a"

#define vmac_string5	"\x72\x6d\x62\x74\x63\x6f\x6c\x6b"	\
						"\x5d\x25\x39\x32\x37\x21\x41\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
...
#define vmac_string6    "\x70\x74\x2a\x37\x6c\x69\x21\x23"	\
						"\x77\x30\x7a\x2f\x34\x41\x6e\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
						"\x00\x00\x00\x00\x00\x00\x00\x00"	\
...
static const struct kbkdf_testvec kbkdf_hmac_sha512_ctr_nist_template[] = {
		{
