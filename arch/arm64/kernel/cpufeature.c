...
static const struct arm64_ftr_bits ftr_id_aa64mmfr1[] = {
	...
	ARM64_FTR_BITS(FTR_HIDDEN, FTR_STRICT_WITH(CONFIG_ARM64_VHE), FTR_LOWER_SAFE, ID_AA64MMFR1_VHE_SHIFT, 4, 0),
	ARM64_FTR_BITS(FTR_HIDDEN, FTR_STRICT_WITH(CONFIG_KVM), FTR_LOWER_SAFE, ID_AA64MMFR1_VMIDBITS_SHIFT, 4, 0),
