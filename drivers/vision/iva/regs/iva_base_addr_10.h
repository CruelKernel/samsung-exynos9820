...
#ifndef __IVA_BASE_ADDR_10_H__
#define __IVA_BASE_ADDR_10_H__
...
#define IVA_VDMA1_BASE_ADDR	(0x000C0000)
...
#define IVA_VDSP_BASE_ADDR	(0x00140000)	/* score sfr */
