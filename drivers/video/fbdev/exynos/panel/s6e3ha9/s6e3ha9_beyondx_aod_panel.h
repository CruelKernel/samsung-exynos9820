...
/* BEYONDX */
static char S6E3HA9_BEYONDX_AOD_SELF_MASK_ENA[] = {
	0x7A,
	0x21, 0x0B, 0xE0, 0x0C,
	0x75, 0x0C, 0x26, 0x0C,
	0xBB, 0x09, 0x0F, 0x00,
...
static DEFINE_STATIC_PACKET(s6e3ha9_beyondx_aod_self_mask_ctrl_ena, DSI_PKT_TYPE_WR, S6E3HA9_BEYONDX_AOD_SELF_MASK_ENA, 0);
static void *s6e3ha9_beyondx_aod_self_mask_ena_cmdtbl[] = {
	&KEYINFO(s6e3ha9_aod_l2_key_enable),
	&PKTINFO(s6e3ha9_beyondx_aod_self_mask_ctrl_ena),
...
static struct seqinfo s6e3ha9_beyondx_aod_seqtbl[MAX_AOD_SEQ] = {
	...
	[SELF_MASK_ENA_SEQ] = SEQINFO_INIT("self_mask_ena", s6e3ha9_beyondx_aod_self_mask_ena_cmdtbl),
