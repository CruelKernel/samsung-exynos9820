...
#if defined(CONFIG_EXYNOS_DSIM_DITHER)
static void dsim_reg_set_dphy_param_dither(u32 id,
...
static u32 dsim_reg_is_hs_clk_ready(u32 id)
{
...
static u32 dsim_reg_is_clk_stop(u32 id)
{
...
static void dsim_reg_enable_per_frame_read(u32 id, u32 en)
{
	u32 val = en ? ~0 : 0;
...
void dpu_sysreg_select_dphy_rst_control(void __iomem *sysreg, u32 dsim_id, u32 sel)
{
	...
	if (sel == 1) /* ignore if dsim driver call this function */
		return;
		...
		bool panel_ctrl)
{
	...
	dpu_sysreg_select_dphy_rst_control(dsim->res.ss_regs, dsim->id, 2);
...
int dsim_reg_stop(u32 id, u32 lanes)
{
	...
	/* This should not be executed if DISPAUD block is not off */
