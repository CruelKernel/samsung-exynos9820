 ...
 *
 * $Id: wlioctl.h 793311 2018-12-07 15:23:47Z $
 */
...
#define WL_HP2P_VERSION		1
typedef struct hp2p_config {
	struct ether_addr peer_addr;
...
typedef enum hp2p_cmd_id {
	...
	WL_HP2P_CMD_CONFIG = 1,
	WL_HP2P_CMD_COUNTERS = 2
} hp2p_cmd_id_t;
#endif /* _wlioctl_h_ */
