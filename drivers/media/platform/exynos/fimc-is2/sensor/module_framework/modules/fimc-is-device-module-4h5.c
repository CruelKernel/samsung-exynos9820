...
static struct fimc_is_sensor_cfg config_module_4h5[] = {
	/* 3280x2458@30fps */
...
static int sensor_module_4h5_power_setpin(struct platform_device *pdev,
...
static int __init sensor_module_4h5_probe(struct platform_device *pdev)
{
	...
	fimc_is_sensor_module_parse_dt(pdev, sensor_module_4h5_power_setpin);
...
static const struct of_device_id exynos_fimc_is_sensor_module_4h5_match[] = {
	{
		.compatible = "samsung,sensor-module-4h5",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_sensor_module_4h5_match);

static struct platform_driver sensor_module_4h5_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-4H5",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_fimc_is_sensor_module_4h5_match,
	}
};

static int __init fimc_is_sensor_module_4h5_init(void)
{
	int ret;
...
late_initcall(fimc_is_sensor_module_4h5_init);
