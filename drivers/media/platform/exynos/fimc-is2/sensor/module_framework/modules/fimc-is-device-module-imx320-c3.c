...
static struct fimc_is_sensor_cfg config_module_imx320_c3[] = {
	/* 3264X2448@30fps */
	FIMC_IS_SENSOR_CFG_EXT(3264, 2448, 30, 14, 0, CSI_DATA_LANES_2, 2145, 0, SET_VC(VC_MIPI_STAT, 3264, 6), 0),
	/* 2448X2448@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2448, 2448, 30, 14, 1, CSI_DATA_LANES_2, 2145, 0, SET_VC(VC_MIPI_STAT, 2448, 8), 0),
	/* 3264X1836@30fps */
	FIMC_IS_SENSOR_CFG_EXT(3264, 1836, 30, 14, 2, CSI_DATA_LANES_2, 2145, 0, SET_VC(VC_MIPI_STAT, 3264, 6), 0),
	/* 1632X918@60fps */
...
static struct fimc_is_vci vci_module_imx320_c3[] = {
	{
...
static int sensor_module_imx320_c3_power_setpin(struct platform_device *pdev,
...
static int __init sensor_module_imx320_c3_probe(struct platform_device *pdev)
{
	...
	fimc_is_sensor_module_parse_dt(pdev, sensor_module_imx320_c3_power_setpin);
...
//#if defined(CONFIG_COMPANION_C3_USE)
	//module->setfile_name = "setfile_imx320_c3.bin";
//#else
...
static const struct of_device_id exynos_fimc_is_sensor_module_imx320_c3_match[] = {
	{
		.compatible = "samsung,sensor-module-imx320-c3",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_sensor_module_imx320_c3_match);

static struct platform_driver sensor_module_imx320_c3_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-IMX320-C3",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_fimc_is_sensor_module_imx320_c3_match,
	}
};

static int __init fimc_is_sensor_module_imx320_c3_init(void)
{
	int ret;
...
late_initcall(fimc_is_sensor_module_imx320_c3_init);
