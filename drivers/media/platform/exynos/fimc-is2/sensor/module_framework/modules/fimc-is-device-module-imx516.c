...
static struct fimc_is_sensor_cfg config_module_imx516[] = {
/* 640 * 480 dual mode / dual freq 8 frame */
FIMC_IS_SENSOR_CFG(1280, 3840, 30, 0, 0, CSI_DATA_LANES_2, 1440, CSI_MODE_DT_ONLY, PD_NONE,
...
FIMC_IS_SENSOR_CFG(640, 1920, 30, 0, 1, CSI_DATA_LANES_2, 1440, CSI_MODE_DT_ONLY, PD_NONE,
...
struct fimc_is_sensor_ops module_imx516_ops = {
...
static int __init sensor_module_imx516_probe(struct platform_device *pdev)
{
	...
	fimc_is_module_parse_dt(dev, sensor_module_imx516_power_setpin);
...
static const struct of_device_id exynos_fimc_is_sensor_module_imx516_match[] = {
	{
		.compatible = "samsung,sensor-module-imx516",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_sensor_module_imx516_match);

static struct platform_driver sensor_module_imx516_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-IMX516",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_fimc_is_sensor_module_imx516_match,
	}
};

static int __init fimc_is_sensor_module_imx516_init(void)
{
	int ret;
...
late_initcall(fimc_is_sensor_module_imx516_init);
