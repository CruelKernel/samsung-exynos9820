...
static struct fimc_is_sensor_cfg config_module_imx241[] = {
	/* 2592x1942@30fps */
	FIMC_IS_SENSOR_CFG(2592, 1942, 30, 20, 0, CSI_DATA_LANES_2),
	/* 2592x1450@30fps */
	FIMC_IS_SENSOR_CFG(2592, 1450, 30, 20, 1, CSI_DATA_LANES_2),
	/* 648x484@60fps */
	FIMC_IS_SENSOR_CFG(648, 484, 114, 24, 2, CSI_DATA_LANES_2),
	/* 648x484@120fps */
	FIMC_IS_SENSOR_CFG(648, 484, 120, 24, 3, CSI_DATA_LANES_2),
};

static struct fimc_is_vci vci_module_imx241[] = {
	{
...
static int sensor_module_imx241_power_setpin(struct platform_device *pdev,
...
static int __init sensor_module_imx241_probe(struct platform_device *pdev)
{
	...
	fimc_is_sensor_module_parse_dt(pdev, sensor_module_imx241_power_setpin);
...
static const struct of_device_id exynos_fimc_is_sensor_module_imx241_match[] = {
	{
		.compatible = "samsung,sensor-module-imx241",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_fimc_is_sensor_module_imx241_match);

static struct platform_driver sensor_module_imx241_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-IMX241",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_fimc_is_sensor_module_imx241_match,
	}
};

static int __init fimc_is_sensor_module_imx241_init(void)
{
	int ret;
...
late_initcall(fimc_is_sensor_module_imx241_init);
