...
int sensor_2l1_cis_long_term_exposure(struct v4l2_subdev *subdev)
{
	...
	if (lte_mode->sen_strm_off_on_enable) {
		...
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x0B52);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x1064);
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x0BFE);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x1064);
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x0C0E);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x1064);
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x0C16);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x1064);
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x858C);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x03C0);

		ret |= fimc_is_sensor_write16(cis->client, 0x0340, 0x7FFF);
		ret |= fimc_is_sensor_write16(cis->client, 0x0342, 0xBF00);
		...
		ret |= fimc_is_sensor_write16(cis->client, 0x6028, 0x2000);
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x0B52);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x0295);
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x0BFE);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x0295);
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x0C0E);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x0295);
		...
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x0295);
		ret |= fimc_is_sensor_write16(cis->client, 0x602A, 0x858C);
		ret |= fimc_is_sensor_write16(cis->client, 0x6F12, 0x0220);

		ret |= fimc_is_sensor_write16(cis->client, 0x0340, 0x0C57);
		ret |= fimc_is_sensor_write16(cis->client, 0x0342, 0x2100);
...
static struct fimc_is_cis_ops cis_ops_2l1 = {
