...
static void csi_hw_g_err_types_from_err(u32 err_src0, u32 err_src1, u32 *err_id)
{
	...
	vresol_err    = fimc_is_hw_get_field_value(err_src1, &csi_fields[CSIS_F_VRESOL_MISMATCH]);
	hresol_err    = fimc_is_hw_get_field_value(err_src1, &csi_fields[CSIS_F_HRESOL_MISMATCH]);
