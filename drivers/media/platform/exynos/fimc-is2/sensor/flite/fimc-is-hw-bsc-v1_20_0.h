...
#define FLITE_REG_LNWDREN				(0x400)
#define FLITE_REG_LNWDREN_SHORT_FIRST(x)		((x) << 31)
#define FLITE_REG_LNWDREN_CLKGATE_ON(x)			((x) << 1)
#define FLITE_REG_LNWDREN_LNWDR_EN(x)			((x) << 0)

#define FLITE_REG_LNWDRSIZE				(0x404)
#define FLITE_REG_LNWDRSIZE_SIZE_H(x)			((x) << 0)
#define FLITE_REG_LNWDRSIZE_SIZE_V(x)			((x) << 16)

#define FLITE_REG_LNWDRPEDESTAL				(0x408)
#define FLITE_REG_LNWDRPEDESTAL_LONG(x)			((x) << 16)
#define FLITE_REG_LNWDRPEDESTAL_SHORT(x)		((x) << 0)

#define FLITE_REG_LNWDRGAIN				(0x40C)
#define FLITE_REG_LNWDRGAIN_LONG(x)			((x) << 16)
#define FLITE_REG_LNWDRGAIN_SHORT(x)			((x) << 0)

#define FLITE_REG_LNWDRMOTION				(0x410)
#define FLITE_REG_LNWDRMOTION_LONG(x)			((x) << 16)
#define FLITE_REG_LNWDRMOTION_SHORT(x)			((x) << 0)

#define FLITE_REG_LNWDRWEIGHT				(0x414)
#define FLITE_REG_LNWDRWEIGHT_LONG(x)			((x) << 16)
#define FLITE_REG_LNWDRWEIGHT_SHORT(x)			((x) << 0)
