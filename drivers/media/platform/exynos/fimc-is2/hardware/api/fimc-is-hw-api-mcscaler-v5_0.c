...
#include "sfr/fimc-is-sfr-mcsc-v5_0.h"
...
void fimc_is_scaler_clear_intr_all(void __iomem *base_addr, u32 hw_id)
{
	...
	switch (hw_id) {
	case DEV_HW_MCSC0:
		reg_val = fimc_is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_SHADOW_COPY_FINISH_OVER_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_COPY_FINISH_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SCALER_OVERFLOW_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_VERTICAL_UNF_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_VERTICAL_OVF_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_HORIZONTAL_UNF_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_HORIZONTAL_OVF_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CORE_FINISH_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA_FINISH_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FRAME_START_INT_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FRAME_END_INT_0], 1);

		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SCALER_INTERRUPT_0], reg_val);
		break;
	case DEV_HW_MCSC1:
		reg_val = fimc_is_hw_set_field_value(reg_val,
			&mcsc_fields[MCSC_F_SHADOW_COPY_FINISH_OVER_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_COPY_FINISH_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SCALER_OVERFLOW_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_VERTICAL_UNF_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_VERTICAL_OVF_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_HORIZONTAL_UNF_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_HORIZONTAL_OVF_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CORE_FINISH_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA_FINISH_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FRAME_START_INT_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FRAME_END_INT_1], 1);

		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SCALER_INTERRUPT_1], reg_val);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
void fimc_is_scaler_disable_intr(void __iomem *base_addr, u32 hw_id)
{
	...
	case DEV_HW_MCSC0:
		...
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CORE_FINISH_INT_MASK_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA_FINISH_INT_MASK_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FRAME_START_INT_MASK_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FRAME_END_INT_MASK_0], 1);

		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SCALER_INTERRUPT_MASK_0], reg_val);
		break;
	case DEV_HW_MCSC1:
		reg_val = fimc_is_hw_set_field_value(reg_val,
		...
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_CORE_FINISH_INT_MASK_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA_FINISH_INT_MASK_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FRAME_START_INT_MASK_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_FRAME_END_INT_MASK_1], 1);

		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SCALER_INTERRUPT_MASK_1], reg_val);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
...
static void fimc_is_scaler0_set_shadow_ctrl(void __iomem *base_addr, enum mcsc_shadow_ctrl ctrl)
{
	...
	case SHADOW_WRITE_START:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_WR_START_0], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_WR_FINISH_0], 0);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SHADOW_REG_CTRL_0], reg_val);
		break;
	case SHADOW_WRITE_FINISH:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_WR_START_0], 0);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_WR_FINISH_0], 1);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SHADOW_REG_CTRL_0], reg_val);
		break;
	default:
		break;
...
static void fimc_is_scaler1_set_shadow_ctrl(void __iomem *base_addr, enum mcsc_shadow_ctrl ctrl)
{
	...
	switch (ctrl) {
	case SHADOW_WRITE_START:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_WR_START_1], 1);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_WR_FINISH_1], 0);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SHADOW_REG_CTRL_1], reg_val);
		break;
	case SHADOW_WRITE_FINISH:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_WR_START_1], 0);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SHADOW_WR_FINISH_1], 1);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SHADOW_REG_CTRL_1], reg_val);
		break;
	default:
		break;
...
void fimc_is_scaler_set_input_img_size(void __iomem *base_addr, u32 hw_id, u32 width, u32 height)
{
	...
	switch (hw_id) {
	case DEV_HW_MCSC0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_IMG_HSIZE_0], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_IMG_VSIZE_0], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_INPUT_IMG_SIZE_0], reg_val);
		break;
	case DEV_HW_MCSC1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_IMG_HSIZE_1], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_INPUT_IMG_VSIZE_1], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_INPUT_IMG_SIZE_1], reg_val);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
	...
	u32 pos_x, u32 pos_y, u32 width, u32 height)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC0_SRC_HPOS], pos_x);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC0_SRC_VPOS], pos_y);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_SRC_POS], reg_val);

		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC0_SRC_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC0_SRC_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_SRC_SIZE], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC1_SRC_HPOS], pos_x);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC1_SRC_VPOS], pos_y);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_SRC_POS], reg_val);

		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC1_SRC_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC1_SRC_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_SRC_SIZE], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC2_SRC_HPOS], pos_x);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC2_SRC_VPOS], pos_y);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_SRC_POS], reg_val);

		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC2_SRC_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC2_SRC_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_SRC_SIZE], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC3_SRC_HPOS], pos_x);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC3_SRC_VPOS], pos_y);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_SRC_POS], reg_val);

		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC3_SRC_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC3_SRC_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_SRC_SIZE], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC4_SRC_HPOS], pos_x);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC4_SRC_VPOS], pos_y);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_SRC_POS], reg_val);

		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC4_SRC_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC4_SRC_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_SRC_SIZE], reg_val);
		break;
	default:
		break;
	}
...
void fimc_is_scaler_set_poly_dst_size(void __iomem *base_addr, u32 output_id, u32 width, u32 height)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC0_DST_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC0_DST_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_DST_SIZE], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC1_DST_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC1_DST_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_DST_SIZE], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC2_DST_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC2_DST_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_DST_SIZE], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC3_DST_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC3_DST_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_DST_SIZE], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC4_DST_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC4_DST_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_DST_SIZE], reg_val);
		break;
	default:
		break;
	}
...
void fimc_is_scaler_set_poly_scaler_h_coef(void __iomem *base_addr, u32 output_id, u32 h_sel)
{
	...
	case MCSC_OUTPUT0:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_H_COEFF_0AB + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_H_COEFF_0CD + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_H_COEFF_0EF + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_H_COEFF_0GH + (4 * index)], reg_val);
		}
		break;
	case MCSC_OUTPUT1:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_H_COEFF_0AB + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_H_COEFF_0CD + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_H_COEFF_0EF + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_H_COEFF_0GH + (4 * index)], reg_val);
		}
		break;
	case MCSC_OUTPUT2:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_H_COEFF_0AB + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_H_COEFF_0CD + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_H_COEFF_0EF + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_H_COEFF_0GH + (4 * index)], reg_val);
		}
		break;
	case MCSC_OUTPUT3:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_H_COEFF_0AB + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_H_COEFF_0CD + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_H_COEFF_0EF + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_H_COEFF_0GH + (4 * index)], reg_val);
		}
		break;
	case MCSC_OUTPUT4:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_H_COEFF_0AB + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_H_COEFF_0CD + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_H_COEFF_0EF + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_H_COEFF_0GH + (4 * index)], reg_val);
		}
		break;
	default:
		break;
...
void fimc_is_scaler_set_poly_scaler_v_coef(void __iomem *base_addr, u32 output_id, u32 v_sel)
{
	...
	case MCSC_OUTPUT0:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_V_COEFF_0AB + (2 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC0_V_COEFF_0CD + (2 * index)], reg_val);
		}
		break;
	case MCSC_OUTPUT1:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_V_COEFF_0AB + (2 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC1_V_COEFF_0CD + (2 * index)], reg_val);
		}
		break;
	case MCSC_OUTPUT2:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_V_COEFF_0AB + (2 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_V_COEFF_0CD + (2 * index)], reg_val);
		}
		break;
	case MCSC_OUTPUT3:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_V_COEFF_0AB + (2 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_V_COEFF_0CD + (2 * index)], reg_val);
		}
		break;
	case MCSC_OUTPUT4:
		for (index = 0; index <= 8; index++) {
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_V_COEFF_0AB + (2 * index)], reg_val);
			reg_val = 0;
			reg_val = fimc_is_hw_set_field_value(reg_val,
			...
			fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_V_COEFF_0CD + (2 * index)], reg_val);
		}
		break;
	default:
		break;
...
void fimc_is_scaler_set_post_img_size(void __iomem *base_addr, u32 output_id, u32 width, u32 height)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_IMG_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_IMG_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC0_IMG_SIZE], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_IMG_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_IMG_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC1_IMG_SIZE], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_IMG_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_IMG_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC2_IMG_SIZE], reg_val);
		break;
	case MCSC_OUTPUT3:
		/* not support */
		break;
...
void fimc_is_scaler_set_post_dst_size(void __iomem *base_addr, u32 output_id, u32 width, u32 height)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_DST_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_DST_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC0_DST_SIZE], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_DST_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_DST_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC1_DST_SIZE], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_DST_HSIZE], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_DST_VSIZE], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC2_DST_SIZE], reg_val);
		break;
	case MCSC_OUTPUT3:
		/* not support */
		break;
...
void fimc_is_scaler_set_post_scaler_h_v_coef(void __iomem *base_addr, u32 output_id, u32 h_sel, u32 v_sel)
{
	...
	case MCSC_OUTPUT0:
		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_H_COEFF_SEL], h_sel);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_V_COEFF_SEL], v_sel);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC0_COEFF_CTRL], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_H_COEFF_SEL], h_sel);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_V_COEFF_SEL], v_sel);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC1_COEFF_CTRL], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_H_COEFF_SEL], h_sel);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_V_COEFF_SEL], v_sel);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC2_COEFF_CTRL], reg_val);
		break;
	case MCSC_OUTPUT3:
		/* not support */
		break;
...
void fimc_is_scaler_set_b_c(void __iomem *base_addr, u32 output_id, u32 y_offset, u32 y_gain)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_BCHS_Y_OFFSET], y_offset);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_BCHS_Y_GAIN], y_gain);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC0_BCHS_BC], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_BCHS_Y_OFFSET], y_offset);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_BCHS_Y_GAIN], y_gain);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC1_BCHS_BC], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_BCHS_Y_OFFSET], y_offset);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_BCHS_Y_GAIN], y_gain);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC2_BCHS_BC], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC3_BCHS_Y_OFFSET], y_offset);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC3_BCHS_Y_GAIN], y_gain);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC3_BCHS_BC], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC4_BCHS_Y_OFFSET], y_offset);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC4_BCHS_Y_GAIN], y_gain);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC4_BCHS_BC], reg_val);
		break;
	default:
		break;
	}
	...
	u32 c_gain00, u32 c_gain01, u32 c_gain10, u32 c_gain11)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_BCHS_C_GAIN_00], c_gain00);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_BCHS_C_GAIN_01], c_gain01);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC0_BCHS_HS1], reg_val);
		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_BCHS_C_GAIN_10], c_gain10);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC0_BCHS_C_GAIN_11], c_gain11);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC0_BCHS_HS2], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_BCHS_C_GAIN_00], c_gain00);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_BCHS_C_GAIN_01], c_gain01);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC1_BCHS_HS1], reg_val);
		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_BCHS_C_GAIN_10], c_gain10);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC1_BCHS_C_GAIN_11], c_gain11);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC1_BCHS_HS2], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_BCHS_C_GAIN_00], c_gain00);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_BCHS_C_GAIN_01], c_gain01);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC2_BCHS_HS1], reg_val);
		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_BCHS_C_GAIN_10], c_gain10);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC2_BCHS_C_GAIN_11], c_gain11);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC2_BCHS_HS2], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC3_BCHS_C_GAIN_00], c_gain00);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC3_BCHS_C_GAIN_01], c_gain01);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC3_BCHS_HS1], reg_val);
		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC3_BCHS_C_GAIN_10], c_gain10);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC3_BCHS_C_GAIN_11], c_gain11);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC3_BCHS_HS2], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC4_BCHS_C_GAIN_00], c_gain00);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC4_BCHS_C_GAIN_01], c_gain01);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC4_BCHS_HS1], reg_val);
		reg_val = 0;
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC4_BCHS_C_GAIN_10], c_gain10);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_PC4_BCHS_C_GAIN_11], c_gain11);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_PC4_BCHS_HS2], reg_val);
		break;
	default:
		break;
	}
	...
	u32 y_max, u32 y_min, u32 c_max, u32 c_min)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC0_BCHS_Y_CLAMP_MAX], y_max);
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC0_BCHS_Y_CLAMP_MIN], y_min);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC0_BCHS_C_CLAMP_MAX], c_max);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC0_BCHS_C_CLAMP_MIN], c_min);
		reg_idx_y = MCSC_R_PC0_BCHS_CLAMP_Y;
		reg_idx_c = MCSC_R_PC0_BCHS_CLAMP_C;
		break;
	case MCSC_OUTPUT1:
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC1_BCHS_Y_CLAMP_MAX], y_max);
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC1_BCHS_Y_CLAMP_MIN], y_min);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC1_BCHS_C_CLAMP_MAX], c_max);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC1_BCHS_C_CLAMP_MIN], c_min);
		reg_idx_y = MCSC_R_PC1_BCHS_CLAMP_Y;
		reg_idx_c = MCSC_R_PC1_BCHS_CLAMP_C;
		break;
	case MCSC_OUTPUT2:
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC2_BCHS_Y_CLAMP_MAX], y_max);
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC2_BCHS_Y_CLAMP_MIN], y_min);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC2_BCHS_C_CLAMP_MAX], c_max);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC2_BCHS_C_CLAMP_MIN], c_min);
		reg_idx_y = MCSC_R_PC2_BCHS_CLAMP_Y;
		reg_idx_c = MCSC_R_PC2_BCHS_CLAMP_C;
		break;
	case MCSC_OUTPUT3:
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC3_BCHS_Y_CLAMP_MAX], y_max);
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC3_BCHS_Y_CLAMP_MIN], y_min);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC3_BCHS_C_CLAMP_MAX], c_max);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC3_BCHS_C_CLAMP_MIN], c_min);
		reg_idx_y = MCSC_R_PC3_BCHS_CLAMP_Y;
		reg_idx_c = MCSC_R_PC3_BCHS_CLAMP_C;
		break;
	case MCSC_OUTPUT4:
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC4_BCHS_Y_CLAMP_MAX], y_max);
		reg_val_y = fimc_is_hw_set_field_value(reg_val_y, &mcsc_fields[MCSC_F_PC4_BCHS_Y_CLAMP_MIN], y_min);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC4_BCHS_C_CLAMP_MAX], c_max);
		reg_val_c = fimc_is_hw_set_field_value(reg_val_c, &mcsc_fields[MCSC_F_PC4_BCHS_C_CLAMP_MIN], c_min);
...
void fimc_is_scaler_set_wdma_sram_base(void __iomem *base_addr, u32 output_id)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_SRAM_BASE],
			&mcsc_fields[MCSC_F_WDMA0_SRAM_BASE], WDMA0_SRAM_BASE_VALUE);
		break;
	case MCSC_OUTPUT1:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_SRAM_BASE],
			&mcsc_fields[MCSC_F_WDMA1_SRAM_BASE], WDMA1_SRAM_BASE_VALUE);
		break;
	case MCSC_OUTPUT2:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_SRAM_BASE],
			&mcsc_fields[MCSC_F_WDMA2_SRAM_BASE], WDMA2_SRAM_BASE_VALUE);
		break;
	case MCSC_OUTPUT3:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_SRAM_BASE],
			&mcsc_fields[MCSC_F_WDMA3_SRAM_BASE], WDMA3_SRAM_BASE_VALUE);
		break;
	case MCSC_OUTPUT4:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_SRAM_BASE],
			&mcsc_fields[MCSC_F_WDMA4_SRAM_BASE], WDMA4_SRAM_BASE_VALUE);
		break;
	case MCSC_OUTPUT_DS:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMADS_SRAM_BASE],
...
{
	/* 0 ~ 4 : otf out path */
	fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_DS_CTRL],
		&mcsc_fields[MCSC_F_DS_CHAIN_SEL], output_id);
}

u32 fimc_is_scaler_get_rdma_format(void __iomem *base_addr, u32 hw_id)
{
	u32 mono = 0, fmt = 0;

	switch (hw_id) {
	case DEV_HW_MCSC0:
		mono = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_SCALER_MONO_CTRL_0],
			&mcsc_fields[MCSC_F_MONO_ENABLE_0]);
		break;
	case DEV_HW_MCSC1:
		mono = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_SCALER_MONO_CTRL_1],
	...
	if (mono)
		...
		fmt = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_RDMAOTF_DATA_FORMAT],
			&mcsc_fields[MCSC_F_RDMAOTF_DATA_FORMAT]);

	return fmt;
}

void fimc_is_scaler_set_rdma_format(void __iomem *base_addr, u32 hw_id, u32 in_fmt)
{
	...
	fimc_is_hw_set_field(base_addr, &mcsc_regs[reg_offset], &mcsc_fields[field_offset], en);
...
void fimc_is_scaler_set_wdma_mono_ctrl(void __iomem *base_addr, u32 output_id, u32 fmt, bool en)
{
	u32 reg_val = 0;

	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_MONO_EN], en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA0_MONO_CTRL], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_MONO_EN], en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA1_MONO_CTRL], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_MONO_EN], en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA2_MONO_CTRL], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_MONO_EN], en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA3_MONO_CTRL], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_MONO_EN], en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA4_MONO_CTRL], reg_val);
		break;
	case MCSC_OUTPUT_DS:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMADS_MONO_EN], en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMADS_MONO_CTRL], reg_val);
		break;
	default:
		break;
	}
...
void fimc_is_scaler_set_wdma_rgb_ctrl(void __iomem *base_addr, u32 output_id, u32 img_fmt, bool en)
{
	u32 reg_val = 0;
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_RGB_EN], en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_RGB_FORMAT], hw_fmt);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA0_RGB_CTRL], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_RGB_EN], en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_RGB_FORMAT], hw_fmt);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA1_RGB_CTRL], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_RGB_EN], en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_RGB_FORMAT], hw_fmt);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA2_RGB_CTRL], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_RGB_EN], en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_RGB_FORMAT], hw_fmt);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA3_RGB_CTRL], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_RGB_EN], en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_RGB_FORMAT], hw_fmt);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA4_RGB_CTRL], reg_val);
		break;
	case MCSC_OUTPUT_DS:
		/* Not support */
		break;
...
void fimc_is_scaler_set_wdma_rgb_coefficient(void __iomem *base_addr, u32 alpha_value)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_ALPHA], alpha_value);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_SRC_Y_OFFSET], 0);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA_RGB_OFFSET], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_COEF_C00], 256);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_COEF_C10], 0);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA_RGB_COEF_0], reg_val);
	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_COEF_C20], 369);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_COEF_C01], 256);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA_RGB_COEF_1], reg_val);
	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_COEF_C11], 32727);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_COEF_C21], 32625);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA_RGB_COEF_2], reg_val);
	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_COEF_C02], 256);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RGB_COEF_C12], 471);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA_RGB_COEF_3], reg_val);
	fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA_RGB_COEF_4],
		&mcsc_fields[MCSC_F_RGB_COEF_C22], 0);

}

void fimc_is_scaler_set_wdma_format(void __iomem *base_addr, u32 hw_id, u32 output_id, u32 out_fmt)
{
	u32 in_fmt;

	in_fmt = fimc_is_scaler_get_rdma_format(base_addr, hw_id);
	...
	case MCSC_RGB_ABGR8888:
		fimc_is_scaler_set_wdma_rgb_ctrl(base_addr, output_id, out_fmt, true);
		fimc_is_scaler_set_wdma_rgb_coefficient(base_addr, 0);	/* alpha is zero */
		out_fmt = MCSC_YUV422_1P_YUYV;
		break;
	case MCSC_MONO_Y8:
		fimc_is_scaler_set_wdma_rgb_ctrl(base_addr, output_id, MCSC_RGB_ARGB8888, false);
		fimc_is_scaler_set_wdma_mono_ctrl(base_addr, output_id, out_fmt, true);
	...
	u32 fmt, u32 bitwidth, enum exynos_sensor_position sensor_position)
{
	...
	case MCSC_OUTPUT0:
		...
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_DITHER_EN], dither_en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_ROUND_EN], round_en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA0_DITHER], reg_val);
		break;
	case MCSC_OUTPUT1:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_10BIT_TYPE],
			&mcsc_fields[MCSC_F_WDMA1_10BIT_TYPE], img_10bit_type);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_DITHER_EN], dither_en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_ROUND_EN], round_en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA1_DITHER], reg_val);
		break;
	case MCSC_OUTPUT2:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_10BIT_TYPE],
			&mcsc_fields[MCSC_F_WDMA2_10BIT_TYPE], img_10bit_type);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_DITHER_EN], dither_en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_ROUND_EN], round_en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA2_DITHER], reg_val);
		break;
	case MCSC_OUTPUT3:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_10BIT_TYPE],
			&mcsc_fields[MCSC_F_WDMA3_10BIT_TYPE], img_10bit_type);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_DITHER_EN], dither_en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_ROUND_EN], round_en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA3_DITHER], reg_val);
		break;
	case MCSC_OUTPUT4:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_10BIT_TYPE],
			&mcsc_fields[MCSC_F_WDMA4_10BIT_TYPE], img_10bit_type);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_DITHER_EN], dither_en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_ROUND_EN], round_en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA4_DITHER], reg_val);
		break;
	case MCSC_OUTPUT_DS:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMADS_DITHER_EN], dither_en);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMADS_ROUND_EN], round_en);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMADS_DITHER], reg_val);
		break;
	default:
		break;
	}
...
void fimc_is_scaler_get_wdma_format(void __iomem *base_addr, u32 output_id, u32 *out_fmt)
{
	switch (output_id) {
	case MCSC_OUTPUT0:
		*out_fmt = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA0_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA0_DATA_FORMAT]);
		break;
	case MCSC_OUTPUT1:
		*out_fmt = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA1_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA1_DATA_FORMAT]);
		break;
	case MCSC_OUTPUT2:
		*out_fmt = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA2_DATA_FORMAT]);
		break;
	case MCSC_OUTPUT3:
		*out_fmt = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA3_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA3_DATA_FORMAT]);
		break;
	case MCSC_OUTPUT4:
		*out_fmt = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMA4_DATA_FORMAT],
			&mcsc_fields[MCSC_F_WDMA4_DATA_FORMAT]);
		break;
	case MCSC_OUTPUT_DS:
		*out_fmt = fimc_is_hw_get_field(base_addr, &mcsc_regs[MCSC_R_WDMADS_DATA_FORMAT],
...
void fimc_is_scaler_set_rdma_size(void __iomem *base_addr, u32 width, u32 height)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RDMAOTF_WIDTH], width);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RDMAOTF_HEIGHT], height);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_RDMAOTF_IMG_SIZE], reg_val);
}
...
void fimc_is_scaler_set_wdma_size(void __iomem *base_addr, u32 output_id, u32 width, u32 height)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_WIDTH], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_HEIGHT], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA0_IMG_SIZE], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_WIDTH], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_HEIGHT], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA1_IMG_SIZE], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_WIDTH], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_HEIGHT], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA2_IMG_SIZE], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_WIDTH], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_HEIGHT], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA3_IMG_SIZE], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_WIDTH], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_HEIGHT], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA4_IMG_SIZE], reg_val);
		break;
	case MCSC_OUTPUT_DS:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMADS_WIDTH], width);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMADS_HEIGHT], height);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMADS_IMG_SIZE], reg_val);
		break;
	default:
		break;
	}
...
void fimc_is_scaler_set_rdma_stride(void __iomem *base_addr, u32 y_stride, u32 uv_stride)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RDMAOTF_Y_STRIDE], y_stride);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RDMAOTF_C_STRIDE], uv_stride);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_RDMAOTF_STRIDE], reg_val);
}
...
void fimc_is_scaler_set_rdma_2bit_stride(void __iomem *base_addr, u32 y_2bit_stride, u32 uv_2bit_stride)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RDMAOTF_2BIT_Y_STRIDE], y_2bit_stride);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_RDMAOTF_2BIT_C_STRIDE], uv_2bit_stride);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_RDMAOTF_2BIT_STRIDE], reg_val);
}
...
void fimc_is_scaler_set_wdma_stride(void __iomem *base_addr, u32 output_id, u32 y_stride, u32 uv_stride)
{
	...
	switch (output_id) {
	case MCSC_OUTPUT0:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_Y_STRIDE], y_stride);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA0_C_STRIDE], uv_stride);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA0_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_Y_STRIDE], y_stride);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA1_C_STRIDE], uv_stride);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA1_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_Y_STRIDE], y_stride);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA2_C_STRIDE], uv_stride);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA2_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_Y_STRIDE], y_stride);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA3_C_STRIDE], uv_stride);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA3_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_Y_STRIDE], y_stride);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMA4_C_STRIDE], uv_stride);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA4_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT_DS:
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMADS_Y_STRIDE], y_stride);
		reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_WDMADS_C_STRIDE], uv_stride);
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMADS_STRIDE], reg_val);
		break;
	default:
		break;
	}
	...
	u32 y_2bit_stride, u32 uv_2bit_stride)
{
	...
	case MCSC_OUTPUT0:
		...
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA0_2BIT_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT1:
		reg_val = fimc_is_hw_set_field_value(reg_val,
		...
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA1_2BIT_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT2:
		reg_val = fimc_is_hw_set_field_value(reg_val,
		...
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA2_2BIT_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT3:
		reg_val = fimc_is_hw_set_field_value(reg_val,
		...
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA3_2BIT_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT4:
		reg_val = fimc_is_hw_set_field_value(reg_val,
		...
		fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_WDMA4_2BIT_STRIDE], reg_val);
		break;
	case MCSC_OUTPUT_DS:
		/* Not supported */
		break;
...
void fimc_is_scaler_set_tdnr_rdma_format(void __iomem *base_addr, enum tdnr_buf_type type, u32 in_fmt)
{
	/* not supported */
}

void fimc_is_scaler_set_tdnr_wdma_format(void __iomem *base_addr, enum tdnr_buf_type type, u32 out_fmt)
{
	/* not supported */
}
	...
	u32 output_id, u32 fmt, u32 plane, u32 dma_idx, u32 width, u32 height)
{
	...
	enum fimc_is_mcsc_hwfc_format hwfc_fmt = 0;
	...
	case MCSC_OUTPUT3:
		...
		/* format */
		val = fimc_is_hw_set_field_value(val, &mcsc_fields[MCSC_F_HWFC_FORMAT_A], hwfc_fmt);
	...
	case MCSC_OUTPUT4:
		...
		/* fmt */
		val = fimc_is_hw_set_field_value(val, &mcsc_fields[MCSC_F_HWFC_FORMAT_B], hwfc_fmt);
...
void fimc_is_scaler_set_ysum_input_sourece_enable(void __iomem *base_addr, u32 output_id, bool ysum_enable)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_YSUM_CHAIN_SEL], output_id);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_YSUM_ENABLE], ysum_enable);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_YSUM_CTRL], reg_val);
}
...
void fimc_is_scaler_set_ysum_enable(void __iomem *base_addr, bool ysum_enable)
{
	...
	reg_val = fimc_is_hw_get_reg(base_addr, &mcsc_regs[MCSC_R_YSUM_CTRL]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_YSUM_ENABLE], ysum_enable);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_YSUM_CTRL], reg_val);
}
...
void fimc_is_scaler_set_ysum_image_size(void __iomem *base_addr, u32 width, u32 height, u32 start_x, u32 start_y)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_YSUM_IMG_SIZE_H], width);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_YSUM_IMG_SIZE_V], height);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_YSUM_IMG_SIZE], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_YSUM_CROP_POS_H], start_x);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_YSUM_CROP_POS_V], start_y);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_YSUM_CROP_POS], reg_val);
}
...
void fimc_is_scaler_set_djag_enable(void __iomem *base_addr, u32 djag_enable)
{
	...
	reg_val = fimc_is_hw_get_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_CTRL]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_ENABLE], djag_enable);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_PS_ENABLE], djag_enable);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_CTRL], reg_val);
}
...
void fimc_is_scaler_set_djag_input_source(void __iomem *base_addr, u32 djag_input_sel)
{
	...
	reg_val = fimc_is_hw_get_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_CTRL]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_INPUT_SEL], djag_input_sel);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_CTRL], reg_val);
}
...
void fimc_is_scaler_set_djag_src_size(void __iomem *base_addr, u32 width, u32 height)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_INPUT_IMG_HSIZE], width);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_INPUT_IMG_VSIZE], height);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_IMG_SIZE], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_PS_SRC_HPOS], 0);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_PS_SRC_VPOS], 0);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_PS_SRC_POS], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_PS_SRC_HSIZE], width);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_PS_SRC_VSIZE], height);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_PS_SRC_SIZE], reg_val);
}
...
void fimc_is_scaler_set_djag_dst_size(void __iomem *base_addr, u32 width, u32 height)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_PS_DST_HSIZE], width);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_PS_DST_VSIZE], height);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_PS_DST_SIZE], reg_val);
}
...
void fimc_is_scaler_set_djag_tunning_param(void __iomem *base_addr, const struct djag_setfile_contents *djag_tune)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_XFILTER_DEJAGGING_WEIGHT0],
		djag_tune->xfilter_dejagging_coeff_cfg.xfilter_dejagging_weight0);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_XFILTER_DEJAGGING_WEIGHT1],
		djag_tune->xfilter_dejagging_coeff_cfg.xfilter_dejagging_weight1);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_XFILTER_HF_BOOST_WEIGHT],
		djag_tune->xfilter_dejagging_coeff_cfg.xfilter_hf_boost_weight);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_CENTER_HF_BOOST_WEIGHT],
		djag_tune->xfilter_dejagging_coeff_cfg.center_hf_boost_weight);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DIAGONAL_HF_BOOST_WEIGHT],
		djag_tune->xfilter_dejagging_coeff_cfg.diagonal_hf_boost_weight);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_CENTER_WEIGHTED_MEAN_WEIGHT],
		djag_tune->xfilter_dejagging_coeff_cfg.center_weighted_mean_weight);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_XFILTER_DEJAGGING_COEFF], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_THRES_1X5_MATCHING_SAD],
		djag_tune->thres_1x5_matching_cfg.thres_1x5_matching_sad);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_THRES_1X5_ABSHF],
		djag_tune->thres_1x5_matching_cfg.thres_1x5_abshf);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_THRES_1X5_MATCHING], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_THRES_SHOOTING_LLCRR],
		djag_tune->thres_shooting_detect_cfg.thres_shooting_llcrr);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_THRES_SHOOTING_LCR],
		djag_tune->thres_shooting_detect_cfg.thres_shooting_lcr);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_THRES_SHOOTING_NEIGHBOR],
		djag_tune->thres_shooting_detect_cfg.thres_shooting_neighbor);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_THRES_SHOOTING_DETECT_0], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_THRES_SHOOTING_UUCDD],
		djag_tune->thres_shooting_detect_cfg.thres_shooting_uucdd);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_THRES_SHOOTING_UCD],
		djag_tune->thres_shooting_detect_cfg.thres_shooting_ucd);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_MIN_MAX_WEIGHT],
		djag_tune->thres_shooting_detect_cfg.min_max_weight);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_THRES_SHOOTING_DETECT_1], reg_val);
	...
	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_0],
		djag_tune->dither_cfg.dither_value[0]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_1],
		djag_tune->dither_cfg.dither_value[1]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_2],
		djag_tune->dither_cfg.dither_value[2]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_3],
		djag_tune->dither_cfg.dither_value[3]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_4],
		djag_tune->dither_cfg.dither_value[4]);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_DITHER_VALUE_04], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_5],
		djag_tune->dither_cfg.dither_value[5]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_6],
		djag_tune->dither_cfg.dither_value[6]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_7],
		djag_tune->dither_cfg.dither_value[7]);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_DITHER_VALUE_8],
		djag_tune->dither_cfg.dither_value[8]);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DJAG_DITHER_VALUE_58], reg_val);
	...
	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_CP_ARBI_MAX_COV_OFFSET],
		djag_tune->cp_cfg.cp_arbi_max_cov_offset);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_CP_ARBI_MAX_COV_SHIFT],
		djag_tune->cp_cfg.cp_arbi_max_cov_shift);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_CP_ARBI_DENOM],
		djag_tune->cp_cfg.cp_arbi_denom);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DJAG_CP_ARBI_MODE],
...
void fimc_is_scaler_set_ds_img_size(void __iomem *base_addr, u32 width, u32 height)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_IMG_HSIZE], width);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_IMG_VSIZE], height);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_IMG_SIZE], reg_val);
}
...
void fimc_is_scaler_set_ds_src_size(void __iomem *base_addr, u32 width, u32 height, u32 x_pos, u32 y_pos)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_CROP_POS_H], x_pos);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_CROP_POS_V], y_pos);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_CROP_POS], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_SRC_HSIZE], width);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_SRC_VSIZE], height);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_SRC_SIZE], reg_val);
}
...
void fimc_is_scaler_set_ds_dst_size(void __iomem *base_addr, u32 width, u32 height)
{
	...
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_DST_HSIZE], width);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_DST_VSIZE], height);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_DST_SIZE], reg_val);
}
...
/* Gamma table : LUT register with default values : it's a value for 10bit */
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_0], 0);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_1], 16);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_GAMMA_TBL_01], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_2], 32);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_3], 48);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_GAMMA_TBL_23], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_4], 60);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_5], 112);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_GAMMA_TBL_45], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_6], 152);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_7], 192);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_GAMMA_TBL_67], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_8], 260);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_9], 316);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_GAMMA_TBL_89], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_A], 420);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_B], 512);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_GAMMA_TBL_AB], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_C], 608);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_D], 708);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_GAMMA_TBL_CD], reg_val);

	reg_val = 0;
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_E], 832);
	reg_val = fimc_is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_DS_GAMMA_TBL_F], 1024);
	fimc_is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_DS_GAMMA_TBL_EF], reg_val);
}
