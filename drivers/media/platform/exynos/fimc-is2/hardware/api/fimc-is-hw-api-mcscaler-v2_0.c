...
#include "sfr/fimc-is-sfr-mcsc-v2_0.h"
...
void fimc_is_scaler_set_dither(void __iomem *base_addr, u32 hw_id, bool dither_en)
{
	...
	case DEV_HW_MCSC0:
		...
		break;
	case DEV_HW_MCSC1:
		fimc_is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_DITHER_1_CTRL], &mcsc_fields[MCSC_F_DITHER_1_ON], dither_en);
		break;
	default:
		warn_hw("invalid hw_id(%d) for MCSC api\n", hw_id);
		break;
