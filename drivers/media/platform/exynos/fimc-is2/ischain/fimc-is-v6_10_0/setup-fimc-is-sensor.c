...
static int exynos9610_fimc_is_csi_gate(struct device *dev, u32 instance, bool mask)
{
	int ret = 0;
...
int exynos9610_fimc_is_sensor_iclk_cfg(struct device *dev,
	u32 scenario,
	u32 channel)
{
	fimc_is_enable(dev, "GATE_DFTMUX_TOP_QCH_CLK_CSIS0");
...
int exynos9610_fimc_is_sensor_iclk_on(struct device *dev,
	u32 scenario,
	u32 channel)
{
	int ret = 0;
	...
	switch (channel) {
	case 0:
		exynos9610_fimc_is_csi_gate(dev, 1, true);
		exynos9610_fimc_is_csi_gate(dev, 2, true);
		exynos9610_fimc_is_csi_gate(dev, 3, true);
		break;
	case 1:
		exynos9610_fimc_is_csi_gate(dev, 0, true);
		exynos9610_fimc_is_csi_gate(dev, 2, true);
		exynos9610_fimc_is_csi_gate(dev, 3, true);
		break;
	case 2:
...
int exynos9610_fimc_is_sensor_iclk_off(struct device *dev,
	u32 scenario,
	u32 channel)
{
	exynos9610_fimc_is_csi_gate(dev, channel, true);
...
int exynos9610_fimc_is_sensor_mclk_on(struct device *dev,
	u32 scenario,
	u32 channel)
{
	char sclk_name[30];
...
int exynos9610_fimc_is_sensor_mclk_off(struct device *dev,
		u32 scenario,
		u32 channel)
{
	char sclk_name[30];
...
int exynos_fimc_is_sensor_iclk_cfg(struct device *dev,
	...
	u32 channel)
{
	exynos9610_fimc_is_sensor_iclk_cfg(dev, scenario, channel);
	return 0;
}
...
int exynos_fimc_is_sensor_iclk_on(struct device *dev,
	...
	u32 channel)
{
	exynos9610_fimc_is_sensor_iclk_on(dev, scenario, channel);
	return 0;
}
...
int exynos_fimc_is_sensor_iclk_off(struct device *dev,
	...
	u32 channel)
{
	exynos9610_fimc_is_sensor_iclk_off(dev, scenario, channel);
	return 0;
}
...
int exynos_fimc_is_sensor_mclk_on(struct device *dev,
	...
	u32 channel)
{
	exynos9610_fimc_is_sensor_mclk_on(dev, scenario, channel);
	return 0;
}
...
int exynos_fimc_is_sensor_mclk_off(struct device *dev,
	...
	u32 channel)
{
	exynos9610_fimc_is_sensor_mclk_off(dev, scenario, channel);
	return 0;
}
