...
enum sysreg_is_reg_name {
	SYSREG_IS_R_CSISX2_MUX_3AA_VAL,
	SYSREG_IS_R_MIPI_DPHY_CTRL,
	SYSREG_IS_REG_CNT
};

enum sysreg_is_reg_field {
	SYSREG_IS_F_CSISX2_MUX_3AA_VAL,
	SYSREG_IS_F_MIPI_PHY_MUX_SEL,
...
#define IORESOURCE_3AA		1
#define IORESOURCE_ISP		2
#define IORESOURCE_MCSC		3
#define IORESOURCE_VRA_CH0	4
#define IORESOURCE_VRA_CH1	5

#define FIMC_IS_RESERVE_LIB_SIZE	(0x01000000)	/* 16MB */
#define FIMC_IS_TAAISP_SIZE		(0x05000000)	/* 80MB */
#define TAAISP_MEDRC_SIZE		(0x00000000)	/* zero */
#define FIMC_IS_VRA_SIZE		(0x00800000)	/* 8MB */

#define SYSREG_IS_BASE_ADDR		0x144C0000
...
/* MC-Scaler */
#define MCSC_INTR_MASK		(0x0001000C)
...
#define MAX_MCSC_DNR_WIDTH		(1920)
#define MAX_MCSC_DNR_HEIGHT		(1080)
#define MAX_MCSC_DNR_NUM_BUFFER		(2)
#define FIMC_IS_MCSC_DNR_SIZE		ALIGN(MAX_MCSC_DNR_WIDTH * MAX_MCSC_DNR_HEIGHT * 2 \
