#ifndef FIMC_IS_VENDOR_CONFIG_DAVINCI5G_H
#define FIMC_IS_VENDOR_CONFIG_DAVINCI5G_H
...
// #define CAMERA_TOF_CAL_TEMP  // for delete
...
#endif /* FIMC_IS_VENDOR_CONFIG_DAVINCI5G_H */
