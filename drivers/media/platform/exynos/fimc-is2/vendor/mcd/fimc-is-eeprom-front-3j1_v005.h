...
#define ROM_HEADER_MTF_DATA_ADDR_FRONT				0xE0
#define ROM_HEADER_MTF_DATA_ADDR_FRONT2				0x116
...
#define ROM_VER_START_ADDR_FRONT2					0x39E0
...
#define ROM_CHECKSUM_ADDR_FRONT2					0x39FC

/* etc section */
#define FIMC_IS_MAX_CAL_SIZE_FRONT					(32 * 1024)
#define HEADER_CRC32_LEN_FRONT						(0x160)
