 ...
 * @gpu_time:  Time in ticks. To get monotonic timestamp multiply it with the system clock speed.
				i.e.gpu monotonic timestamp =  gpu_time * 1000/26  (if system clock speed is 26Mhz)
