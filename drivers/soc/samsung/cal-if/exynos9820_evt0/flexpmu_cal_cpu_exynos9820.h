...
struct pmucal_seq core00_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 8), (0x1 << 8), 0x15870000, 0x0108, (0x1 << 8), (0x1 << 8) | (0x1 << 8)),
...
struct pmucal_seq core01_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP2_INTR_BID_CLEAR", 0x15870000, 0x020c, (0x1 << 1), (0x1 << 1), 0x15870000, 0x0208, (0x1 << 1), (0x1 << 1) | (0x1 << 1)),
...
struct pmucal_seq core01_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 1), (0x1 << 1), 0x15870000, 0x0108, (0x1 << 1), (0x1 << 1) | (0x1 << 1)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 9), (0x1 << 9), 0x15870000, 0x0108, (0x1 << 9), (0x1 << 9) | (0x1 << 9)),
...
struct pmucal_seq core02_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP2_INTR_BID_CLEAR", 0x15870000, 0x020c, (0x1 << 2), (0x1 << 2), 0x15870000, 0x0208, (0x1 << 2), (0x1 << 2) | (0x1 << 2)),
...
struct pmucal_seq core02_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 2), (0x1 << 2), 0x15870000, 0x0108, (0x1 << 2), (0x1 << 2) | (0x1 << 2)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 10), (0x1 << 10), 0x15870000, 0x0108, (0x1 << 10), (0x1 << 10) | (0x1 << 10)),
...
struct pmucal_seq core03_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP2_INTR_BID_CLEAR", 0x15870000, 0x020c, (0x1 << 3), (0x1 << 3), 0x15870000, 0x0208, (0x1 << 3), (0x1 << 3) | (0x1 << 3)),
...
struct pmucal_seq core03_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 3), (0x1 << 3), 0x15870000, 0x0108, (0x1 << 3), (0x1 << 3) | (0x1 << 3)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 11), (0x1 << 11), 0x15870000, 0x0108, (0x1 << 11), (0x1 << 11) | (0x1 << 11)),
...
struct pmucal_seq core10_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP2_INTR_BID_CLEAR", 0x15870000, 0x020c, (0x1 << 4), (0x1 << 4), 0x15870000, 0x0208, (0x1 << 4), (0x1 << 4) | (0x1 << 4)),
...
struct pmucal_seq core10_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 4), (0x1 << 4), 0x15870000, 0x0108, (0x1 << 4), (0x1 << 4) | (0x1 << 4)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 12), (0x1 << 12), 0x15870000, 0x0108, (0x1 << 12), (0x1 << 12) | (0x1 << 12)),
...
struct pmucal_seq core11_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP2_INTR_BID_CLEAR", 0x15870000, 0x020c, (0x1 << 5), (0x1 << 5), 0x15870000, 0x0208, (0x1 << 5), (0x1 << 5) | (0x1 << 5)),
...
struct pmucal_seq core11_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 5), (0x1 << 5), 0x15870000, 0x0108, (0x1 << 5), (0x1 << 5) | (0x1 << 5)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 13), (0x1 << 13), 0x15870000, 0x0108, (0x1 << 13), (0x1 << 13) | (0x1 << 13)),
...
struct pmucal_seq core20_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP2_INTR_BID_CLEAR", 0x15870000, 0x020c, (0x1 << 6), (0x1 << 6), 0x15870000, 0x0208, (0x1 << 6), (0x1 << 6) | (0x1 << 6)),
...
struct pmucal_seq core20_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 6), (0x1 << 6), 0x15870000, 0x0108, (0x1 << 6), (0x1 << 6) | (0x1 << 6)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 14), (0x1 << 14), 0x15870000, 0x0108, (0x1 << 14), (0x1 << 14) | (0x1 << 14)),
...
struct pmucal_seq core21_on[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP2_INTR_BID_CLEAR", 0x15870000, 0x020c, (0x1 << 7), (0x1 << 7), 0x15870000, 0x0208, (0x1 << 7), (0x1 << 7) | (0x1 << 7)),
...
struct pmucal_seq core21_off[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 7), (0x1 << 7), 0x15870000, 0x0108, (0x1 << 7), (0x1 << 7) | (0x1 << 7)),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE_RETRY, "GRP1_INTR_BID_CLEAR", 0x15870000, 0x010c, (0x1 << 15), (0x1 << 15), 0x15870000, 0x0108, (0x1 << 15), (0x1 << 15) | (0x1 << 15)),
