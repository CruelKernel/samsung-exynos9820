...
enum clk_id cmucal_vclk_ip_lhm_atb_isplpisphq[] = {
	GOUT_BLK_ISPHQ_UID_LHM_ATB_ISPLPISPHQ_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_atb_isphqdip[] = {
...
enum clk_id cmucal_vclk_ip_lhm_atb_dipisplp[] = {
	GOUT_BLK_ISPLP_UID_LHM_ATB_DIPISPLP_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_atb_cipisplp[] = {
	GOUT_BLK_ISPLP_UID_LHM_ATB_CIPISPLP_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_atb_isplpisphq[] = {
...
enum clk_id cmucal_vclk_ip_lhs_axi_d_npu[] = {
...
struct vclk_lut cmucal_vclk_mux_clk_aud_uaif3_lut[] = {
	...
	{516000, mux_clk_aud_uaif3_nm_lut_params},
...
struct vclk_lut cmucal_vclk_div_clk_aud_dmic_lut[] = {
	{25800, div_clk_aud_dmic_nm_lut_params},
	{25000, div_clk_aud_dmic_uud_lut_params},
	{25000, div_clk_aud_dmic_ud_lut_params},
};
struct vclk_lut cmucal_vclk_div_clk_aud_mclk_lut[] = {
	{51600, div_clk_aud_mclk_nm_lut_params},
...
struct vclk_lut cmucal_vclk_clkcmu_hpm_lut[] = {
	...
	{533000, clkcmu_hpm_ud_lut_params},
...
struct vclk_lut cmucal_vclk_div_clk_fsys1_mmc_card_lut[] = {
	{800000, div_clk_fsys1_mmc_card_ud_lut_params},
	{26000, div_clk_fsys1_mmc_card_uud_lut_params},
};
...
struct vclk_switch switch_vdd_ananke[] = {
	{MUX_CLK_CPUCL0_PLL, MUX_CLKCMU_CPUCL0_SWITCH, CLKCMU_CPUCL0_SWITCH, GATE_CLKCMU_CPUCL0_SWITCH, MUX_CLKCMU_CPUCL0_SWITCH_USER, mux_clk_cpucl0_pll_lut, 4},
};
...
/*================================ VCLK List =================================*/
unsigned int cmucal_vclk_size = 911;
...
/* DVFS VCLK*/
	...
	CMUCAL_VCLK(VCLK_VDD_ANANKE, cmucal_vclk_vdd_ananke_lut, cmucal_vclk_vdd_ananke, NULL, switch_vdd_ananke),
...
/* SPECIAL VCLK*/
	...
	CMUCAL_VCLK(VCLK_DIV_CLK_AUD_DMIC, cmucal_vclk_div_clk_aud_dmic_lut, cmucal_vclk_div_clk_aud_dmic, NULL, NULL),
...
/* GATE VCLK*/
	...
	CMUCAL_VCLK(VCLK_IP_LHM_ATB_ISPLPISPHQ, NULL, cmucal_vclk_ip_lhm_atb_isplpisphq, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_ATB_ISPHQDIP, NULL, cmucal_vclk_ip_lhs_atb_isphqdip, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_ATB_DIPISPLP, NULL, cmucal_vclk_ip_lhm_atb_dipisplp, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_ATB_CIPISPLP, NULL, cmucal_vclk_ip_lhm_atb_cipisplp, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_ATB_ISPLPISPHQ, NULL, cmucal_vclk_ip_lhs_atb_isplpisphq, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_D_NPU, NULL, cmucal_vclk_ip_lhs_axi_d_npu, NULL, NULL),
