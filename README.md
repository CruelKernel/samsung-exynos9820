...
Supported devices: G970F/N, G973F, G975F/N G977B/N, N970F, N975F,
N971N, N976B/N.
...
Reboot to TWRP. Flash boot.img in boot slot. Reboot to system.
...
of your phone. You can select multiple models. Supported models are: G970F/N, G973F,
...
OS patch date can be changed with ```os_patch_level=2020-09``` argument,
...
* simple_lmk - use simple low memory killer instead of lmdk.
...
* usb_serial - enable usb serial console support for nodemcu/arduino devices.
...
$ sudo dnf install ncurses-devel ncurses-compat-libs bc bison flex elfutils-libelf-devel openssl-devel heimdall android-tools
...
# ./cruelbuild flash name="CustomCruel" model=G973F toolchain=proton +magisk=canary +wireguard +ttl +cifs +nohardening
```
