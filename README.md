...
the default current date is in build.mkbootimg.G973F file.
...
# Compile
$ ./build mkimg name="CustomCruel" model=G973F toolchain=proton +magisk=canary +wireguard +ttl +cifs +nohardening
...
# ./build flash name="CustomCruel" model=G973F toolchain=proton +magisk=canary +wireguard +ttl +cifs +nohardening
```
